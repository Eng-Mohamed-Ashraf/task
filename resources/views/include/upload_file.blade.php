        ...
        AIZ.uploader = {
            ...
            removeInputValue: function (id, array, elem) {
                ...
                if (selected.length > 0) {
                    ...
                    elem.find(".file-amount").html("File");
                }
            ...
            selectFolderMultable:function(element){
                        ...
                        function (data) {
                            ...
                            if (data.length > 0) {
                                ...
                                for (
                                    ...
                                    var first_input= $(element).parents('.department').find('.form_debart:first').find('.selected-files').val()

                                    if(first_input>0){
                                        $(element).parents('.department').find('.add_debart').click()
                                    }
                                    var elem= $(element).parents('.department').find('.form_debart:last').find('.input-group')


                                    elem.find(".selected-files").val(data[i].id);
                                    var thumb = "";
                                    ...
                                    elem.next(".file-preview").html(html);
                                }
                            } else {
                                elem.find(".file-amount").html("File");
                            }
                ...
                $(".aiz-uploader-select").each(function () {
                    ...
                    elem.on("click", function (e) {
                       ...
                       var types=$(this).data('types')
                        ...
                        if(types=='folder'){
                            $('#folder_id_new').val(value)

                                var value = $('[name="aiz-uploader-search"]').val()
                                AIZ.uploader.getAllUploads(
                                    "{{route("get_uploaded_files")}}",
                                    value,
            ...
            getAllUploads: function (url, search_key = null, sort_key = null) {
                ...
                params['folder_id']=$('#folder_id_new').val()
                $.get(url, params, function (data, status) {
                    ...
                    AIZ.uploader.data.allfolder = folder;
                    AIZ.uploader.data.parent = parent;

                    AIZ.uploader.allowedFileType();
                    AIZ.uploader.addSelectedValue();
                    AIZ.uploader.addHiddenValue();
                    //AIZ.uploader.resetFilter();
                    AIZ.uploader.updateUploaderFolder();
                     AIZ.uploader.updateUploaderFiles();
            ...
            updateUploaderFiles: function () {
                ...
                setTimeout(function () {
                    ...
                    var data_folders = AIZ.uploader.data.allfolder;
                    if (data.length > 0||data_folders.length>0) {
...
thumb='<video  controls> ' +
    '<source width="100%" src="'+AIZ.data.fileBaseUrl +
                                data[i].file_name+'" >' +
    '<source src="'+AIZ.data.fileBaseUrl +
    ...
    'Your browser does not support the video tag. </video>'
            ...
            updateUploaderFolder: function () {
                $(".aiz-uploader-all").html(
                    '<div class="align-items-center d-flex h-100 justify-content-center w-100"><div class="spinner-border" role="status"></div></div>'
                );

                var data = AIZ.uploader.data.allfolder;
            ...
            inputSelectPreviewGenerate: function (elem) {
                var type=$(elem).data('types')
                if(type=='folder'){
                    AIZ.uploader.selectFolderMultable(elem)
                ...
                $.get(
                    ...
                    function (data) {
                        ...
                        $('#up_level').click(function () {
                            ...
                            var id=AIZ.uploader.data.parent
                       ...
                       "{{route("get_file_by_ids")}}",
                        ...
                        function (data) {
                            ...
                            if (data.length > 0) {
                                ...
                                $this.find(".file-amount").html("File");
                            }
                        });
                });
            }
            ...
            aizUppy: function () {
                if ($("#aiz-upload-files").length > 0) {
                    ...
                    uppy.use(Uppy.XHRUpload, {
                        endpoint: "{{route("aiz_uploader_upload")}}",
                        fieldName: "aiz_file",
                        formData: true,
                        headers: {
                ...
                $(".custom-file input").change(function (e) {
                    ...
                    if (files.length === 1) {
                        ...
                        $(this)
                            ...
                            .html(files.length + "File Select");
                    } else {
                        $(this).next(".custom-file-name").html("File");
                    }
                });
            },
